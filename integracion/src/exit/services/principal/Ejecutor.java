...
import exit.services.principal.peticiones.facebook.GetFacebookLeads;
...
public class Ejecutor {
	...
	public Object ejecutorServicioACsvFACEBOOK() throws Exception{
		AbstractHTTP getGenerico= new GetFacebookLeads();
		Object proximaUrl=getGenerico.realizarPeticion(EPeticiones.GET, RecuperadorPropiedadedConfiguracionEntidad.getInstance().getUrl());
		while(proximaUrl!=null){
			System.out.println(proximaUrl);
			proximaUrl=getGenerico.realizarPeticion(EPeticiones.GET, proximaUrl.toString());
		}
		return null;
	}
